...
class DepartemenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('departemen')->with('succses','Departemen Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect('departemen')->with('succses','Departemen Berhasil Dirubah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('departemen')->with('succes','Departemen Berhasil Dihapus');
    }
}
